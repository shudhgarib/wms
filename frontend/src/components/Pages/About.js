...
const About = () => {
  return (
    <>
      <div className="container" style={{color: "#6eecba"}}>
        <div className="page" style={{marginTop: "20px"}}>
          <h4>संझौली छठ पूजा समिति !</h4>
          <hr />
          <p align="center">
            <b>
            ...
            गरीमा को बरकरार रखते हुए समिति की बागडोर संभालते हुए ।<b>
              {" "}
              2017
            </b>{" "}
            तक लाए और आगे की जिमेवारी को संभालने के लिए नव निर्वाचित अध्यक्ष{" "}
            ...
            <b> मध्य में स्थित सूर्य भगवान की प्रतिमा</b> हम सभी की मन मोहते
            हैं, और चारो तरफ बच्चे, बुजुर्ग, वर्ती, माताएं बहनों, भाई बंधुओं,
        ...
        <div className="page">
          <h4> छठ पर्व किस प्रकार मनाते हैं ?</h4>
          <hr />
          <p>
        ...
        <div className="page">
          <h4> सामाजिक/सांस्कृतिक महत्त्व </h4>
          <hr />
          <p>
            <b>
